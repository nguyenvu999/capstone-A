// // MapNavbar.jsx
// // Navbar cho map page với search, register place button, user dropdown
...
//     if (words.length >= 2) {
//       // Trường hợp: Vu Vu -> VV, Khang Pham Nguyen -> KP
...
//   // Handle search khi user nhấn Enter hoặc submit form
...
//         {/* Search Bar */}
//         <form onSubmit={handleSearchSubmit} className="mx-auto hidden max-w-md flex-1 md:flex">
...
//                   onError={(e) => {
//                     // Nếu link ảnh Microsoft lỗi (403/404), ẩn thẻ img ngay lập tức
